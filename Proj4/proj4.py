...
class ANN:
    def __init__(self, training_set, test_set):
        ...
        #self.input_hidden = {j:[random.uniform(-0.01, 0.01) for i in range(self.num_inputs)] for j in range(self.num_hidden)}
        #self.hidden_output = 
        ...
        """
        for val in self.perceptron:
            print(str(val) + "," + str(self.perceptron[val]))
            time.sleep(1)
        """
